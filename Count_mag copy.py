...
if __name__ == "__main__":
    ...
    minim = max(np.max(B_array_1), np.max(B_array_2))
    maxim = min(np.min(B_max_array_1), np.min(B_max_array_2))
    ...
    contour1 = axes[0].contour(grid_R, grid_Z, B_grid_1, levels=10, cmap="plasma")
    axes[0].plot(R_phi, Z_phi, color="red", linewidth=1)
    axes[0].set_title('w7x-sc1.bc')

    contour2 = axes[1].contour(grid_R, grid_Z, J_0_grid_1, levels=10, cmap="plasma")
    axes[1].plot(R_phi, Z_phi, color="red", linewidth=1)
    axes[1].set_title('J_0')

    contour3 = axes[2].contour(grid_R, grid_Z, B_grid_2, levels=10, cmap="plasma")
    axes[2].plot(R_phi, Z_phi, color="red", linewidth=1)
    axes[2].set_title('w7x-sc1_ecrh_beta=0.04.bc')

    contour4 = axes[3].contour(grid_R, grid_Z, J_0_grid_2, levels=10, cmap="plasma")
