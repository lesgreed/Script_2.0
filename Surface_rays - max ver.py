...
def visualisation(surface,lines1, lines2,NBI_index,new_P_1,valid_indices, new_NBI_start,extreme_points_1,extreme_points_2, valid_lines, P_name):
    ...
    # Создаем 3D точку и добавляем на график
    point_mesh = pv.PolyData(point_center)  # Преобразуем в PolyData
    plotter.add_mesh(point_mesh, color="red", point_size=10, render_points_as_spheres=True)
